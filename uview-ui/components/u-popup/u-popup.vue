<template>
	<view v-if="visibleSync" :style="[customStyle, {
		...
		<u-mask v-if="maskShow" :duration="duration" :custom-style="maskCustomStyle" :maskClickAble="maskCloseAble" :z-index="uZindex - 2" :show="showDrawer && mask" @click="maskClick"></u-mask>
		<view
