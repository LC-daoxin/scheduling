<template>
	<view class="userbox">
		<view class="user_header">
			<view class="head_box" :style="{'padding-top': BarHeight}">
				<u-avatar class="head_img" :src="userSrc" mode="circle" size="130"></u-avatar>
				<text class="head_name">用户20200918</text>
			</view>
